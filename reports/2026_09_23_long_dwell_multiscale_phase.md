...
The duration trend localizes two mechanisms. First, extending one constant
receiver-product residual-frequency fit across 300--600 ms reduces held
coherence, despite the explicit historical affine carrier derotation. The
...
The replay demodulates each RX/source using the historical affine carrier in
...
This frontend recreates the documented fixed eight-tone, symbols 2--65
