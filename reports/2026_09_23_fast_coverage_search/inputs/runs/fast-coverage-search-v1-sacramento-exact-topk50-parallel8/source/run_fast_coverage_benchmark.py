            ...
            for spacing in args.spacings_km:
                ...
                result = {
                    ...
                    "newly_scored_points": (
                        ...
                        if parallel_metrics
                        else evaluator.metrics()["fully_scored_cell_count"]
                    ...
                    "partially_scored_pruned_points": (
                        ...
                        if parallel_metrics
                        else evaluator.metrics()["early_abandoned_cell_count"]
                    ...
                    "preexisting_full_score_cache_hits": (
                        ...
                        if parallel_metrics
                        else evaluator.metrics()["cache_hits"] - metrics_before["cache_hits"]
                    ),
