...
Final aggregate verification against the previously deployed `9948c311` passed
all 30 selected gates: 25 pytest selections, mypy, Ruff checks/formatting, web
tests and web build. Replay fixtures initially rejected scratch space beneath
`/srv/bulk/leo`, as their archive-protection guard requires. Rerunning in a
separate `/srv/bulk/scanner-r21-tests.*` directory passed without code or
assertion changes. The failed-run receipt is retained locally; the passing
receipt is `.leo/test-receipts/a483211bd12af7146e74d8219e27b556291864441b835790dfd30b77888ec967.json`.
