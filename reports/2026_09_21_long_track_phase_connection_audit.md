...
The large contiguous-half disagreements in the longest-track report therefore remain **estimator-repeatability failures**, not proof of physical receiver instability or non-geometric satellite motion. A bounded controlled-signal and saved-IQ audit is required to separate these causes. Published evidence is retained unchanged; no phase alias should be selected by making the result resemble an expected orbit.
