...
def create_plan() -> None:
    ...
    plan = {
        "schema": "paired-ds1-ds3-iteration30-soft-preflight-plan/v2",
...
def validate_plan(plan: dict[str, Any]) -> None:
    if (
        plan.get("schema") != "paired-ds1-ds3-iteration30-soft-preflight-plan/v2"
...
def run() -> None:
    ...
    candidate_artifact = {
        "schema": "paired-ds1-ds3-iteration30-candidates/v2",
        "plan": digest(PLAN),
        "truth_used": False,
        "held_used": False,
    ...
    influence_artifact = {
        "schema": "paired-ds1-ds3-iteration30-influence/v2",
        "plan": digest(PLAN),
        "truth_used": False,
        "held_used": False,
    ...
    output = {
        "schema": "paired-ds1-ds3-iteration30-soft-preflight/v2",
        "complete": True,
        "plan": digest(PLAN),
        "runner": digest(Path(__file__)),
