#!/usr/bin/env python3
"""Post-seal evaluation and visualization for DS1 iteration 16."""
...
def main() -> None:
    ...
    result = {
        "schema": "ds1-iteration16-dynamic-association-postseal/v1",
    ...
    axes[1].legend()
    figure.savefig(args.output_dir / "dynamic-association-basin.png", dpi=180)
