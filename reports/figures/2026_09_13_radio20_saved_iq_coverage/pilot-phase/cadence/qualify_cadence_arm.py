...
def main():
    output = EVIDENCE / 'cadence-arm-v1-results'; output.mkdir(exist_ok=False)
    ...
    try:
        lease = authority.claim(('radio_pluto_5d4d',), task_id='cadence-arm-v1', task_kind=CaptureTaskKind.QUALIFICATION)
