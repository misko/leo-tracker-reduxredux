...
def review(root,rows=None,expected_spacing=9):
    ...
    while at<len(rows):
        ...
        assert start['epoch']==seed['epoch'] and start['first_frame']==seed['last_seen']+expected_spacing
        ...
        for index,r in enumerate(measurements):
            ...
            assert r['rate']==RATE and r['sequence']==index and r['frame']==start['first_frame']+expected_spacing*index
