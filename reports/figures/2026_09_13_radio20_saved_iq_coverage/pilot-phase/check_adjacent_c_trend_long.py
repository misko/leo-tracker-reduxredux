...
def main():
    ...
    result = dict(scope='production_C_trend_saved_positive_up_to_frame_1799', new_rf_samples=0,
    ...
    for old in prior['cases']:
        ...
        if case['label'] == 'positive':
            ...
            assert digest(path) == 'af991e03e69271c253d2fe6b5aeff110c9da5d5bd6ddda8c6850584f9e97b1c4'
