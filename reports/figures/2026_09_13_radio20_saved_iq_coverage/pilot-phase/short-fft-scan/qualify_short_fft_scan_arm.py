...
def main():
    ...
    for k, data in payload.items():
        assert hashlib.sha256(data).hexdigest() == build["payloads"][k]
    ...
    evidence = dict(
        scope="saved_IQ_bounded_scan_ARM_compute",
        new_rf_samples=0,
        native_jobs=0,
        ...
        try:
            ...
            for repeat in range(3):
                for fft_size in (4096, 8192, 16384):
                    ...
                    name = f"fft{fft_size}-r{repeat}.jsonl"
