...
OUT = Path(
    "/home/mouse9911/gits/leo-radio20-reboot-publish/reports/figures/2026_09_13_radio20_live_passive_observer"
)
...
def main():
    ...
    result = {
        "scope": "live_passive_coarse_observer_integration",
        ...
        "host_independent_review": read(
            BASE / "passive-observer-live-host-v1/independent-review.json"
        ),
        "live_operator": read(ROOT / "operator.json"),
        "live_stdout": read(ROOT / "stdout.json"),
        ...
        "arm_saved_replay_review": read(
            BASE / "paced-live-observer-arm-v1-results/independent-review.json"
        ),
    ...
    for filename in (
        "review_live_observer.py",
        "review_live_observer_capture.py",
        "record_live_observer_integration.py",
        "record_live_observer_result.py",
        "paced_replay_live_observer.c",
        "qualify_paced_live_observer.py",
        "review_paced_live_observer.py",
    ):
