...
def review(root):
    ...
    assert op['payload_sha256']['probe']=='2dfe31cc68d8f9fd5dd63fe0ae284aa7fe95de721a8f716dc279681a0c2ea0b2'
    ...
    for index,scan in enumerate(scans):
        ...
        for epoch,frequency,score in scan['peaks']:
            ...
            powers.append(float(max(abs(np.fft.fft(z*np.conj(ref),16384))**2)/
