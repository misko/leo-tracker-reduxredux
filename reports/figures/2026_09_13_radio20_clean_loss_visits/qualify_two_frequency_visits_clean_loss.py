...
def main():
    if len(sys.argv) not in (3,5): raise SystemExit('usage: qualify_two_frequency_visits_multirate.py NEW_OUTPUT DEPLOYMENT_RECEIPT [FIRST_UPPER_CHANNEL SECOND_UPPER_CHANNEL]')
    ...
    rate=int(matched[1])
    payload={'probe':(E/'glrt-cpu-visit-probe-v5').read_bytes(),
