...
def main():
    ...
    for n in sorted(by_rx[0]):
        ...
        for name,lift in [('pilot_principal',False),('pilot_branch_lifted',True),('pilot_common_authority',True),('pilot_shared_residual',True)]:
            try:
                if name in ('pilot_common_authority','pilot_shared_residual'):
    ...
    for name,color in [('pilot_principal','tab:red'),('pilot_branch_lifted','tab:purple'),('pilot_common_authority','tab:blue'),('pilot_shared_residual','tab:green')]:
