...
def main():
    result = {
        "scope": "physical_30MS_upper_edge_two_visit_qualification",
        "native_tracking_qualified": False,
        "bounded_visits_qualified": True,
        "fw_commit": "56ebc20955b88fd16579defcb75e233de5720aef",
    ...
    with (OUT / "evidence-completed.json").open("x") as f:
        json.dump(result, f, indent=2)
        f.write("\n")
    print(
        json.dumps(
            {
                "output": str(OUT / "evidence-completed.json"),
                "sha256": digest(OUT / "evidence-completed.json"),
