#!/usr/bin/env python3
"""Post-seal evaluation and visualization for DS1 iteration 15."""
...
def main() -> None:
    ...
    result = {
        "schema": "ds1-iteration15-information-weighted-postseal/v1",
    ...
    axes[0].plot(
        ...
        "o-",
        label="information-weighted path",
    )
    axes[0].scatter(
        [truth_east],
        [truth_north],
    ...
    axes[1].legend()
    figure.savefig(args.output_dir / "information-weighted-basin.png", dpi=180)
