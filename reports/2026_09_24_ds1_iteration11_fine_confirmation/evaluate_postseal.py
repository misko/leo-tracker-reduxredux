#!/usr/bin/env python3
"""Evaluate sealed iteration-11 inference after selection is complete."""
...
def main() -> None:
    ...
    row = {
        ...
        "east_km_from_iteration10": winner["east_km_from_iteration10"],
        "north_km_from_iteration10": winner["north_km_from_iteration10"],
    ...
    (args.output_dir / "iteration11-postseal.json").write_text(
        json.dumps(
            {
                "schema": "ds1-iteration11-postseal/v1",
                "reference_role": "post-seal only",
                "rows": [row],
            },
            indent=2,
    ...
    with (args.output_dir / "iteration11-postseal.csv").open("w", newline="") as handle:
    ...
    figure.savefig(args.output_dir / "iteration11-postseal.png", dpi=160)
