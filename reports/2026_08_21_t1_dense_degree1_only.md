...
With the dense inventory, the four straight epochs support **888** evidence-bearing probes. At the previously suspicious 7.5–7.9 s endpoint, the controlled hyperparameter ablation recovered 16/16 probes within 500 Hz with 32 basins, versus 12/16 with the persisted eight-basin search. Finer CFO/GLRT spacing alone recovered 15/16 and left a 2.66 kHz worst miss; more basins alone recovered 16/16 with a 311 Hz worst miss. Thus basin truncation was the dominant local failure, while finer frequency sampling mainly reduced refinement error.
