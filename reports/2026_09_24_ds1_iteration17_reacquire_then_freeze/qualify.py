#!/usr/bin/env python3
"""Reference-free exact replay gate for iteration 17."""
...
ASSOCIATION_UPDATE = (
    ROOT
    / "reports/2026_09_24_ds1_iteration17_reacquire_then_freeze/frozen-association-update.json"
)
...
def main() -> None:
    ...
    output = {
        "schema": "ds1-iteration17-reacquire-then-freeze-qualification/v1",
