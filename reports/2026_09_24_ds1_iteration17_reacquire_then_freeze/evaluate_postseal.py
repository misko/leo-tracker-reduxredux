#!/usr/bin/env python3
"""Post-seal evaluation and visualization for DS1 iteration 17."""
...
def main() -> None:
    ...
    result = {
        "schema": "ds1-iteration17-reacquire-then-freeze-postseal/v1",
    ...
    axes[0].plot(
        ...
        "o-",
        label="reacquire-once, then frozen path",
    )
    axes[0].scatter(
        [truth_east],
        [truth_north],
    ...
    axes[1].legend()
    figure.savefig(args.output_dir / "reacquire-then-freeze-basin.png", dpi=180)
