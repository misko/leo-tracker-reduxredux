"""One bounded 262144-sample refill comparison; installed release and native rate unchanged."""
...
RELEASE = "eefcb4f080907c51cddb505944ed4b1caf899751"
OUTPUT = Path("/var/tmp/leo-radio003a-block262144-restore-20260912.json")
BULK = Path("/srv/bulk/leo-radio003a-block262144-restore-20260912")
...
def main():
    ...
    values.update(
        ...
        LEO_SCANNER_PERSISTENT_SAMPLES_PER_BLOCK="262144",
    ...
    report = dict(
        ...
        purpose="70-second 1 MiB refill comparison; not 300-second duty qualification",
        status="prepared",
        maximum_capture_call_seconds=100,
    )
