...
The implementation sequence below originated as a proposal from a read-only
branch review. A subsequent authorized hardware test is now complete:
[60 MS/s Ethernet measurements and the 1R1T metadata blocker](2026_09_12_ethernet60_measurement.md).
On `.17`, ordinary 60 MS/s IQ delivered 74.40–74.50 MB/s, about 31% of continuous
CI16 input. The largest contiguous 60 MS/s chunk remains unproved: v0.49 metadata
requires 2R2T, while this board's CMOS interface caps 2R2T at 30.72 MS/s.
Fixing that single-RX timestamp dependency is the first implementation gate;
[firmware issue #97](https://github.com/misko/plutosdr-fw/issues/97) documents it.
The measured bandwidth supports evaluating configurable 64–128 µs windows plus
a 2.5 MS/s inspection lane; their simultaneous operation has not been implemented.
