...
def inventory():
    ...
    for day, hour in [(21, 0), (21, 8), (21, 16), (22, 0), (22, 8)]:
        ...
        rows.extend({'session_id': sid, 'nominal_duration_s': 300,
                     'contained_nominal_interval': True} for sid in ids)
    return {'window_start': '2026-09-20T16:35:28+00:00',
            'window_end_exclusive': '2026-09-23T16:35:28+00:00',
            'utc_8h_groups': groups, 'scans': rows, 'excluded_ids': []}
