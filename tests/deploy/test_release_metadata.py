...
def test_production_runtime_identity_is_direct_async_v3_libiio() -> None:
    assert GLOBALS["PRODUCTION_METADATA_ABI"] == 3
    assert GLOBALS["PRODUCTION_LIBIIO_SOURCE_COMMIT"] == "0d323080a0a1067da8c7adbadfd03ee186a40ec2"
