...
def test_full_deployment_plan_binds_exact_production_capture_policy(
    ...
    assert plan["capture_policy_id"] == "production-direct-async-2p5-10-15-25-hold-6-v1"
...
def test_deployment_environment_adds_new_reviewed_rate_profile_bindings(
    ...
    assert values["LEO_MIXED_RATE_POLICY"] == "production-direct-async-2p5-10-15-25-hold-6-v1"
