  ...
  return <section className="scanner-artifact-panel" aria-label="Shared satellite trajectory tracking">
    ...
    {p && <>
      ...
      {p.review_count !== undefined && p.review_eligible_count !== undefined &&
        <p>{p.review_count} of {p.review_eligible_count} eligible track reviews rendered · {p.deferred_review_count ?? 0} deferred{p.review_limit === undefined ? "." : ` · limit ${p.review_limit}.`}</p>}
