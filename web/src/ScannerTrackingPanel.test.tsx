...
const product = {
  ...
  review_limit: 128, review_eligible_count: 1, review_count: 1, deferred_review_count: 0,
...
it.each([2500000, 5000000, 10000000])("shows every published figure and actual failures at %s samples/s", async rate => {
  ...
  expect(screen.getByText("1 of 1 eligible track reviews rendered · 0 deferred · limit 128.")).toBeInTheDocument();
