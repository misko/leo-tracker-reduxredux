...
class AuthoritativeCalibrationResolver:
    ...
    def resolve(
        ...
        if (
            ...
            or current.native_release.evidence_digest != receipt.native_release_evidence_digest
            ...
            or current.native_release.interpreter_digest != receipt.promoter_interpreter_digest
