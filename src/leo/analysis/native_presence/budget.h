...
#endif
#ifndef LEO_PRESENCE_DIFFERENTIAL_CI16
#define LEO_PRESENCE_DIFFERENTIAL_CI16 0
#endif
...
#endif
#if LEO_PRESENCE_DIFFERENTIAL_CI16 < 0 || LEO_PRESENCE_DIFFERENTIAL_CI16 > 1 || \
    (LEO_PRESENCE_DIFFERENTIAL_CI16 && !LEO_PRESENCE_DIFFERENTIAL_PROPOSAL)
#error "integer folding requires the differential proposal"
#endif
