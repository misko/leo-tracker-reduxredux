...
PSS_GLRT_FRAME_COMPARISON_PNG_V3_PRODUCT = _png("standard.pss-glrt-frame-comparison-png", 3)
...
PAIRED_PSS_GLRT_PRESENTATION_NATIVE_OUTPUTS = (PSS_GLRT_FRAME_COMPARISON_PNG_V3_PRODUCT,)
