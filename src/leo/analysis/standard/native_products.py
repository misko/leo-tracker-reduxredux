...
PATH_STANDARD_NATIVE_OUTPUTS = (
    ...
    GLRT64_TRAJECTORY_TABLE_V4_PRODUCT,
    TRAJECTORY_CONDITIONED_ACCOUNTING_V3_PRODUCT,
    CFO_ALIAS_MAP_V3_PRODUCT,
    DEALIASED_TRAJECTORY_BANK_V5_PRODUCT,
    CFO_LIFT_REPLAY_V5_PRODUCT,
    FINAL_TRAJECTORY_BANK_V4_PRODUCT,
    GLRT64_FINAL_TRAJECTORY_TABLE_V4_PRODUCT,
    KALMAN_TRACKING_V2_PRODUCT,
    PILOT_DOPPLER_SEGMENTS_V3_PRODUCT,
    FULL_CAPTURE_GLRT20MS_V1_PRODUCT,
    PATH_REPORT_V3_PRODUCT,
    PATH_PRESENTATION_V5_PRODUCT,
    *STANDARD_NATIVE_PNG_PRODUCTS,
...
if STANDARD_NATIVE_REGISTRY_OUTPUT_COUNT != 44:
