"""Deterministic one-second/50 ms/20 ms Standard probe scheduling."""

from __future__ import annotations

from leo.contracts.digests import canonical_digest
from leo.contracts.standard_pipeline import ProbeScheduleV1, ProbeWindowV1
...
def build_probe_schedule(
    *,
    ...
    source_probe_count = complete_seconds * probes_per_second
    ...
    for coarse_index in range(returned_seconds):
        ...
        for subwindow_index in range(probes_per_second):
            sample_start = coarse_start + subwindow_index * subwindow_samples
            identity = {
                "algorithm_version": "standard-probe-schedule-v1",
