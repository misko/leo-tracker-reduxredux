...
def _spec(
    key: str,
    *,
    algorithm_version: str = "standard-v2-production-2",
...
class PathStandardAnalyzer:
    ...
    spec = _spec(
        "path-standard",
        algorithm_version="standard-v2-production-3",
...
def production_standard_v2_registry() -> AnalyzerRegistry:
    ...
    if sum(len(registry.get(key).spec.output_products) for key in registry.keys) != 35:
