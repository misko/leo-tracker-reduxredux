...
from leo.analysis.standard.products import (
    ...
    PILOT_DOPPLER_SEGMENTS_V1_PRODUCT,
    PILOT_SCAN_PRODUCT,
...
_MODELS: dict[tuple[str, int], type[BaseModel]] = {
    ...
    (DEALIASED_TRAJECTORY_BANK_V3_PRODUCT.kind, 3): DealiasedTrajectoryBankV3,
    (DEALIASED_TRAJECTORY_BANK_PRODUCT.kind, 4): DealiasedTrajectoryBankV4,
    (DEALIASED_TRAJECTORY_BANK_V1_PRODUCT.kind, 1): DealiasedTrajectoryBankV1,
    (CFO_LIFT_REPLAY_V1_PRODUCT.kind, 1): CfoLiftReplayV1,
    (CFO_LIFT_REPLAY_V2_PRODUCT.kind, 2): CfoLiftReplayV2,
    (CFO_LIFT_REPLAY_V3_PRODUCT.kind, 3): CfoLiftReplayV3,
    (CFO_LIFT_REPLAY_V4_PRODUCT.kind, 4): CfoLiftReplayV4,
    (FINAL_TRAJECTORY_BANK_V1_PRODUCT.kind, 1): FinalTrajectoryBankV1,
    (FINAL_TRAJECTORY_BANK_V2_PRODUCT.kind, 2): FinalTrajectoryBankV2,
    (FINAL_TRAJECTORY_BANK_PRODUCT.kind, 3): FinalTrajectoryBankV3,
    (GLRT64_FINAL_TRAJECTORY_TABLE_V1_PRODUCT.kind, 1): Glrt64FinalTrajectoryTableV1,
    (GLRT64_FINAL_TRAJECTORY_TABLE_V2_PRODUCT.kind, 2): Glrt64FinalTrajectoryTableV2,
