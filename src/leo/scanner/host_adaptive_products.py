...
def bind_actual_visit_analysis(
    ...
    configuration_model: type[AdaptiveHopAnalysisConfigurationV1] = (
        HostAdaptiveAnalysisConfigurationV2 if host else AdaptiveHopAnalysisConfigurationV1
    )
    binding_model: type[AdaptiveHopAnalysisBindingV1] = (
        HostAdaptiveAnalysisBindingV2 if host else AdaptiveHopAnalysisBindingV1
    )
