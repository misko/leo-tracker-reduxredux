...
OUTPUT_ROOT = REPOSITORY_ROOT / "reports/figures/2026_08_25_fractional_delay_grid"
...
def main() -> None:
    ...
    evidence = {
        ...
        "artifacts": {
            "script": {
                "path": _repository_path(Path(__file__)),
                "sha256": _sha256(Path(__file__)),
            },
            "rows": {
                "path": _repository_path(rows_path),
                "sha256": _sha256(rows_path),
            },
            "plot": {
                "path": _repository_path(plot_path),
