...
`memory=4`, and `heavy=16`. A missing, duplicate, extra, malformed, or drifted
row blocks startup.
...
silently renormalized timeline.
...
`heavy=16`. Each worker forces OpenBLAS, OpenMP, and MKL to at most ten threads
